import ctypes
from ctypes import (
    POINTER, byref, c_void_p, c_ulong, c_char_p, c_int32, c_long
)
import ctypes.util
...
def create_query_dict(class_name: str, is_root: bool = None, is_issuer: bool = None):
    ...
    kCFTypeDictionaryKeyCallBacks = ctypes.c_void_p.in_dll(corefoundation, "kCFTypeDictionaryKeyCallBacks")
    kCFTypeDictionaryValueCallBacks = ctypes.c_void_p.in_dll(corefoundation, "kCFTypeDictionaryValueCallBacks")
    ...
    if class_name == "cert":
        ...
        values.extend([kSecClassCertificate, kSecMatchLimitAll, ctypes.c_void_p(1), ctypes.c_void_p(1)])
